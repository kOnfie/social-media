  ...
  return (
    <Container>
      <div className="text-center my-[40px]">
        <h1 className="text-[40px] font-semibold text-center">OTP Verification</h1>

        <p className="text-[var(--color-text-secondary)] text-[14px]">Verify your OTP to access your account</p>
      </div>
